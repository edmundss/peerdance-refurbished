                    ...
                    <a href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false">
                        <span class="meta">
                            <span class="avatar avatar-inline">
                                    @if($sessionOwner->avatar)
                                        <img src="{{$sessionOwner->getAvatar('xs')}}" alt="" class="img-circle max-w-35">
                            ...
                            <span class="name">{{$sessionOwner->name}}</span>
                            <span class="caret"></span>
                        </span>
                    </a>
                    <ul class="dropdown-menu btn-primary dropdown-menu-right">
                        <li>
                            <a href="{{route('users.show', $sessionOwner)}}"><i class="zmdi zmdi-account"></i> Profile</a>
                        </li>
                        {{--
                        <li>
