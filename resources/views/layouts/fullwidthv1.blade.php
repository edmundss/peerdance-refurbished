		...
		<aside id="app_sidebar-left">
			...
			<section id="content_outer_wrapper">
				<div id="content_wrapper" class="card-overlay">
					<div id="header_wrapper" class="{{$header_size ?? 'header-md'}}">
								...
								<div class="tab-pane fade" id="sidebar_settings">
									<div class="color-container">
										...
										<div class="row">
											<div class="col-xs-3 p-0">
												<div class="color-option-check">
													<label data-load-css="{{asset('assets/css/theme-a.css')}}">
											...
											<div class="col-xs-3 p-0">
												<div class="color-option-check">
													<label data-load-css="{{asset('assets/css/theme-b.css')}}">
											...
											<div class="col-xs-3 p-0">
												<div class="color-option-check">
													<label data-load-css="{{asset('assets/css/theme-c.css')}}">
														<input type="radio" name="setting-theme">
														<span class="icon-check"></span>
														<span class="split">
											...
											<div class="col-xs-3 p-0">
												<div class="color-option-check">
													<label data-load-css="{{asset('assets/css/theme-d.css')}}">
														<input type="radio" name="setting-theme">
														<span class="icon-check"></span>
														<span class="split">
										...
										<div class="row m-t-20">
											<div class="col-xs-3 p-0">
												<div class="color-option-check">
													<label data-load-css="{{asset('assets/css/theme-e.css')}}">
														<input type="radio" name="setting-theme" checked="checked">
														<span class="icon-check"></span>
														<span class="split">
											...
											<div class="col-xs-3 p-0">
												<div class="color-option-check">
													<label data-load-css="{{asset('assets/css/theme-f.css')}}">
														<input type="radio" name="setting-theme">
														<span class="icon-check"></span>
														<span class="split">
											...
											<div class="col-xs-3 p-0">
												<div class="color-option-check">
													<label data-load-css="{{asset('assets/css/theme-g.css')}}">
														<input type="radio" name="setting-theme">
														<span class="icon-check"></span>
														<span class="split">
											...
											<div class="col-xs-3 p-0">
												<div class="color-option-check">
													<label data-load-css="{{asset('assets/css/theme-h.css')}}">
														<input type="radio" name="setting-theme">
														<span class="icon-check"></span>
														<span class="split">
